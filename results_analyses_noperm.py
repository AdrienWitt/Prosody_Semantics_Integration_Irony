...
# SETTINGS
# ================================
TOP_PERCENTILE   = 99.9        # 99.5 = top 0.5%, 99.9 = top 0.1%
MIN_CLUSTER_SIZE = 5           # minimum cluster size
OUTPUT_NAME      = f"top{(100 - TOP_PERCENTILE):.1f}pct_k{MIN_CLUSTER_SIZE}_ALLvox"

# ================================
# 1. Load correlation maps
# ================================
results_dir = "results_pca70"
...
# ================================
# 2. Brain mask + coordinate mapping
# ================================
...
# ================================
# 5. Filter: minimum cluster size
# ================================
valid_clusters = []
print(f"\nFiltering {n_clusters} clusters → keeping only k ≥ {MIN_CLUSTER_SIZE}...")
...
for lbl in range(1, n_clusters + 1):
    ...
    print(f"  Kept cluster {lbl:3d} | k={size:4d} | peak Δr={peak_val:.5f}")
...
print("\n" + "="*110)
print(f"FINAL RESULT – {len(valid_clusters)} clusters (top {100-TOP_PERCENTILE:.1f}%, k ≥ {MIN_CLUSTER_SIZE})")
print("="*110)
